...
<head>
    <title>Dooars Utsav | Loko Moncho</title>
...
<body class="events-news-page">
                ...
                <div class="row">
                    <div class="col-12">
                        <header class="entry-header">
                            <h1 class="entry-title">Loko Sanskriti Moncho</h1>
                        </header>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="swiper-container homepage-regional-events-slider">
                    ...
                    <figure>
                        <img src="img/loko/loko2.jpg"  height="550" width="260" alt="">
                        <h4 class="entry-title">A view of Loko MOncho</h4>
                    </figure>
